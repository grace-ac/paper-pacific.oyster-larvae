...
```{r}
MSstatsContrastMatrix(contrasts = )
```
...
write.csv(proteinComparisonResults, "analyses/20220614-2015Cgseed-peptidecomp.csv", col.names = c("Peptide", "Label", "log2FC", "SE", "Tvalue", "DF", "pvalue"), row.names = F) #write out comparison
```
