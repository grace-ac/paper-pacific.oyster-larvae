...
A threshold of >2.00 and <-2.00 log-2 fold change was decided to be significant for determining differntially abundant proteins between the two temperature treatments (differs from default in MS Stats). 
